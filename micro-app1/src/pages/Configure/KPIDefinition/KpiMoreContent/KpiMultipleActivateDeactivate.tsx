...
import { statusUpdateKpi } from 'redux/actions/ConfigureActions/kpiActions';

const KpiMultipleActiveDeactive: React.FC<any> = ({
    multipleRecord,
    selectedUserIds,
    paginatedPayload,
    searchPayload,
        ...
        <>
            ...
            {status === userActivateDeactivate.activateDeactivate ? (
                ...
                <ConfirmationModal
                    ...
                    text={`Are you sure you want to ${status} these KPIs?`}
                    icon={
                        status === userActivateDeactivate.activate ? (
                            <ActivateUserModal />
            ...
            <SuccessfulModal
                ...
                text={
                    status === userActivateDeactivate.activateDeactivate
                        ? 'KPIs Activated/Deactivated Successfully'
                        : status === userActivateDeactivate.activate
...
export default KpiMultipleActiveDeactive;
