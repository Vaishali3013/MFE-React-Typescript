...
import { KPITYPE, attributeActivateDeactivate } from 'types/enums';
import {
    getKpiDetails,
    setKpiState,
    statusUpdateKpi,
...
const KpiMoreContent: React.FC<{
    ...
    const handleEditClick = (): void => {
        dispatch(getKpiDetails(record?.id));
        dispatch(setKpiState(KPITYPE.edit));
    ...
    const statusUpdateKpiResponse = useSelector(
        (state: any) => state?.configure?.kpi?.statusUpdateKpi
    );
    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                text="Are you sure you want to activate the selected KPIs?"
                icon={<ActivateIcon />}
            />
            ...
            <ConfirmationModal
                ...
                text="Are you sure you want to deactivate the selected KPIs?"
                icon={<DeactiveIcon />}
            />
