...
import {
    getAttributeDetails,
    setAttributeState,
    statusUpdateAttribute,
} from 'redux/actions/ConfigureActions/attributeActions';
import { ATTRIBUTETYPE, attributeActivateDeactivate } from 'types/enums';
...
const AttributeMoreContent: React.FC<{
    ...
    const handleEditClick = (): void => {
        dispatch(getAttributeDetails(record?.id));
        dispatch(setAttributeState(ATTRIBUTETYPE.edit));
    ...
    const statusUpdateAttributeResponse = useSelector(
        (state: any) => state?.configure?.attributes?.statusUpdateAttribute
    );
    ...
    useEffect(() => {
        if (statusUpdateAttributeResponse) {
    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                text="Are you sure you want to activate the selected Attribute?"
                icon={<ActivateIcon />}
            />
            ...
            <ConfirmationModal
                ...
                text="Are you sure you want to deactivate the selected Attribute?"
                icon={<DeactiveIcon />}
            />
