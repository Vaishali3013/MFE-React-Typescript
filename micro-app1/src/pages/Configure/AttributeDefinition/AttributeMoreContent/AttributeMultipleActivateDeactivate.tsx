...
import './index.scss';
import { statusUpdateAttribute } from 'redux/actions/ConfigureActions/attributeActions';
import { parseJwt } from 'utils/jwtTokenFunction';

const AttributeMultipleActiveDeactive: React.FC<any> = ({
    multipleRecord,
    selectedUserIds,
    paginatedPayload,
    searchPayload,
    ...
    const onOkHandler = (): any => {
        if (status === userActivateDeactivate.deactivate) {
            const updatedPayload = {
                attributeIdList: selectedUserIds,
                isActive: false,
        ...
        <>
            ...
            {status === userActivateDeactivate.activateDeactivate ? (
                ...
                <ConfirmationModal
                    ...
                    text={`Are you sure you want to ${status} these Attributes?`}
                    icon={
                        status === userActivateDeactivate.activate ? (
                            <ActivateUserModal />
...
export default AttributeMultipleActiveDeactive;
