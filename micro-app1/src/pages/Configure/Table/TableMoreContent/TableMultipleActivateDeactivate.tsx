...
import { statusUpdateTable } from 'redux/actions/ConfigureActions/tableAction';

const TableMultipleActivateDeactivate: React.FC<any> = ({
    multipleRecord,
    selectedUserIds,
    paginatedPayload,
    searchPayload,
        ...
        <>
            ...
            {status === userActivateDeactivate.activateDeactivate ? (
                ...
                <ConfirmationModal
                    ...
                    text={`Are you sure you want to ${status} these Tables?`}
                    icon={
                        status === userActivateDeactivate.activate ? (
                            <ActivateUserModal />
            ...
            <SuccessfulModal
                ...
                text={
                    status === userActivateDeactivate.activateDeactivate
                        ? 'Tables Activated/Deactivated Successfully'
                        : status === userActivateDeactivate.activate
...
export default TableMultipleActivateDeactivate;
